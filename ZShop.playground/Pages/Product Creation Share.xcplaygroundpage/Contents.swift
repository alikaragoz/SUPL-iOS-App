...
AppEnvironment.replaceCurrentEnvironment(
  apiService: MockService(getProductUrlResponse: ProductUrlResponse(url: URL(string: "https://edxy5.zshop.ovh")!)),
  mainBundle: Bundle.framework,
  userDefaults: defaults
)

let vc = ProductCreationShare.configuredWith(product: .template)
